...
class Draw_DC_IV():
    ...
    def full_ReRAM_info(self, dict_of_measurs: dict, I_on_off: dict, V_on_off: np.array, current_scale: int = 1000, bins: int = 10, start_color: str = '#ff0000', end_color: str = '#1e00ff', **kwargs):
        ...
        ax_3_1.hist(I_on_off['I_on'] * current_scale, bins=bins, rwidth=0.8, edgecolor = 'k')
        ax_3_1.set_title('Гистограмма')
        ax_3_1.tick_params(left = False, labelleft = False) 
        ax_3_2.hist(I_on_off['I_off'] * current_scale, bins=bins, rwidth=0.8, edgecolor = 'k')
        ax_3_2.tick_params(left = False, labelleft = False) 
        ax_3_3.hist(V_on_off[0], bins=bins, rwidth=0.8, edgecolor = 'k')
        ax_3_3.tick_params(left = False, labelleft = False) 
        ax_3_4.hist(V_on_off[1],bins=bins, rwidth=0.8,  edgecolor = 'k')
